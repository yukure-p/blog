        ...
        <main>
          <div class="contents-box">
            ...
            <!-- <div class="table-of-content">
              ...
              <?php get_template_part('article-com/autoflat'); ?>
              <?php elseif(get_field('idname') == 'karumo'):?>
              <?php get_template_part('article-com/karumo'); ?>
              <?php elseif(get_field('idname') == 'kinto'):?>
              <?php get_template_part('article-com/kinto'); ?>
              <?php elseif(get_field('idname') == 'mota'):?>
              <?php get_template_part('article-com/mota'); ?>
              <?php elseif(get_field('idname') == 'cosmo'):?>
              <?php get_template_part('article-com/cosmo'); ?>
              <?php elseif(get_field('idname') == 'sompo'):?>
              <?php get_template_part('article-com/sompo'); ?>
              <?php elseif(get_field('idname') == 'noridoki'):?>
              <?php get_template_part('article-com/noridoki'); ?>
              <?php elseif(get_field('idname') == 'kuruka'):?>
              <?php get_template_part('article-com/kuruka'); ?>
              <?php elseif(get_field('idname') == 'nikonori'):?>
              <?php get_template_part('article-com/nikonori'); ?>
              <?php endif; ?>
                ...
                <div class="l-aside local">
                    ...
                    <div class="l-aside-inner">
                        <ul class="l-aside-menu index" id="indexList">
                            <?php get_template_part('inc/local-aside-com'); ?>
                        </ul>
                    </div>
                </div>
            </div>
